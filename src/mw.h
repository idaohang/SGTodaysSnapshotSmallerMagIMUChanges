...
typedef struct config_t
{
    ...
    float    angleTrim[2];                  // accelerometer trim
    ...
    uint8_t  bar_noise;                     // [0 - 50cm] Override preset baronoise parameters. Noise is in cm, 0 uses preset sensordefaults, only change it if you know what u are doing.
