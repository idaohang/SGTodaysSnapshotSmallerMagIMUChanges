...
const clivalue_t valueTable[] =
{
    ...
    { "acc_trim_pitch",            VAR_FLOAT,  &cfg.angleTrim[PITCH],         -300,        300, 1 },
    { "acc_trim_roll",             VAR_FLOAT,  &cfg.angleTrim[ROLL],          -300,        300, 1 },
    ...
    { "bar_noise",                 VAR_UINT8,  &cfg.bar_noise,                   0,         50, 0 },
...
static void cliDebug(char *cmdline)
{
    ...
    {
        printxyzcalval(cfg.accZero, 0, false);
